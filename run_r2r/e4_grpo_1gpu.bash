...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E4_EXP_NAME:-e4_r2r_gaussian_bev_${ITERS}}
BASE_CKPT=${E4_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
PRETRAINED=${E4_PRETRAINED:-pretrained/r2r_rxr_ce/mlm.sap_habitat_depth/store2/model_step_367500.pt}
...
echo "E4 Gaussian BEV | ${ITERS} iterations | ${NENV} environment(s)"
