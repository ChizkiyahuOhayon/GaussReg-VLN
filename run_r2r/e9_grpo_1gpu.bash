...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E9_EXP_NAME:-e9_r2r_setwise_grpo_${ITERS}}
BASE_CKPT=${E9_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
PRETRAINED=${E9_PRETRAINED:-pretrained/r2r_rxr_ce/mlm.sap_habitat_depth/store2/model_step_367500.pt}
...
echo "E9 setwise GRPO | ${ITERS} iterations | ${NENV} environment(s)"
python -m torch.distributed.launch --nproc_per_node=1 --master_port "${PORT}" run.py \
    ...
    GRPO.setwise_group_policy True \
