...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E3_EXP_NAME:-e3_r2r_candidate_scorer_${ITERS}}
BASE_CKPT=${E3_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
...
echo "E3 candidate scorer | ${ITERS} iterations | ${NENV} environment(s)"
python -m torch.distributed.launch --nproc_per_node=1 --master_port "${PORT}" run.py \
    ...
    GRPO.candidate_scorer_only True \
