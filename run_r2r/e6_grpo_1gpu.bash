...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E6_EXP_NAME:-e6_r2r_hindsight_stop_${ITERS}}
BASE_CKPT=${E6_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
PRETRAINED=${E6_PRETRAINED:-pretrained/r2r_rxr_ce/mlm.sap_habitat_depth/store2/model_step_367500.pt}
...
echo "E6 hindsight stop | ${ITERS} iterations | ${NENV} environment(s)"
