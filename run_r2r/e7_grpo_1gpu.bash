...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E7_EXP_NAME:-e7_r2r_terminal_commit_${ITERS}}
BASE_CKPT=${E7_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
PRETRAINED=${E7_PRETRAINED:-pretrained/r2r_rxr_ce/mlm.sap_habitat_depth/store2/model_step_367500.pt}
...
echo "E7 terminal commit | ${ITERS} iterations | ${NENV} environment(s)"
