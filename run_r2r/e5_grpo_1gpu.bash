...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E5_EXP_NAME:-e5_r2r_anchor_repair_${ITERS}}
BASE_CKPT=${E5_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
PRETRAINED=${E5_PRETRAINED:-pretrained/r2r_rxr_ce/mlm.sap_habitat_depth/store2/model_step_367500.pt}
...
echo "E5 anchor-relative repair | ${ITERS} iterations | ${NENV} environment(s)"
