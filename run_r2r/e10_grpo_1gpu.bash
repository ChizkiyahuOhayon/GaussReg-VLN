...
NENV=${2:-1}
PORT=${3:-2334}
EXP_NAME=${E10_EXP_NAME:-e10_r2r_frontier_advantage_${ITERS}}
BASE_CKPT=${E10_BASE_CKPT:-data/logs/checkpoints/release_r2r_grpo/store/ckpt.iter270.pth}
PRETRAINED=${E10_PRETRAINED:-pretrained/r2r_rxr_ce/mlm.sap_habitat_depth/store2/model_step_367500.pt}
...
echo "E10 FrontierAdv-R1 | ${ITERS} iterations | ${NENV} environment(s)"
python -m torch.distributed.launch --nproc_per_node=1 --master_port "${PORT}" run.py \
    ...
    GRPO.frontier_advantage True \
    GRPO.frontier_advantage_start 1.0 \
    GRPO.frontier_advantage_end 0.25 \
    GRPO.frontier_progress_clip 3.0 \
